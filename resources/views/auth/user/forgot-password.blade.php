        ...
        <div class="mx-auto w-full max-w-md">
            <div class="text-center">
                <h1 class="text-3xl font-black tracking-tight text-slate-900 dark:text-white uppercase tracking-tighter">
                    Recover Access</h1>
                <p class="mt-3 text-sm font-medium text-slate-500 dark:text-zinc-400">Enter your email to receive a
                    secure recovery link.</p>
            </div>
            ...
            <div
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="email"
                            class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Account
                            Email</label>
                    ...
                    <div class="pt-4 text-center">
                        <a href="{{ route('login') }}"
                            class="text-[10px] font-black uppercase tracking-widest text-zinc-400 hover:text-blue-600 transition">Back
                            to Login</a>
                    </div>
                </form>
            </div>
