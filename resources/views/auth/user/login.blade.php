<x-guest-layout :title="'Collector Login'">
        ...
        <div class="mx-auto w-full max-w-md">
            ...
            <div
                ...
                <div class="mt-8 border-t border-slate-50 pt-8 text-center text-xs font-bold dark:border-white/5">
                    <span class="text-slate-400">New Collector?</span>
                    <a href="{{ route('register') }}"
                        class="ml-1 text-slate-900 underline decoration-brand-gold decoration-2 underline-offset-4 hover:text-brand-gold transition dark:text-white">Initialize
                        Account</a>
                </div>
            </div>
