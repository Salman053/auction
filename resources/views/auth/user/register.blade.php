    ...
    <div class="mx-auto flex min-h-[70vh] flex-col justify-center py-20">
        <div class="mx-auto w-full max-w-md">
            <div class="text-center">
                <div
                    class="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-lg bg-brand-navy dark:bg-brand-gold">
                ...
                <p class="mt-3 text-sm font-medium text-slate-500 dark:text-zinc-400">Initialize your account to access
                    the Japanese watch market.</p>
            </div>
            ...
            <div
                ...
                <form method="POST" action="{{ route('register.store') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="name"
                            class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Legal
                            Identity / Display Name</label>
                    ...
                    <div>
                        <label for="email"
                            class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Primary
                            Access Email</label>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            <label for="password"
                                class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Private
                                Pass-Key</label>
                    ...
                    <p class="text-[10px] leading-relaxed text-slate-400">
                        By initializing your account, you agree to our <a href="#"
                            class="text-brand-gold underline underline-offset-2">Collector Terms</a> and <a
                            href="#" class="text-brand-gold underline underline-offset-2">Market Logistics
                            Protocols</a>.
                    </p>
                ...
                <div class="mt-8 border-t border-slate-50 pt-8 text-center text-xs font-bold dark:border-white/5">
                    ...
                    <a href="{{ route('login') }}"
                        class="ml-1 text-slate-900 underline decoration-brand-gold decoration-2 underline-offset-4 hover:text-brand-gold transition dark:text-white">Access
                        Dashboard</a>
                </div>
            </div>

            <p class="mt-10 text-center text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">Vault-Grade
                Data Protection Enabled</p>
        </div>
    </div>
</x-guest-layout>
