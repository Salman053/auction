    ...
    <div class="mx-auto flex min-h-[60vh] flex-col justify-center py-20">
        <div class="mx-auto w-full max-w-md">
            <div class="text-center">
                <h1 class="text-3xl font-black tracking-tight text-slate-900 dark:text-white uppercase tracking-tighter">New Pass-Key</h1>
                <p class="mt-3 text-sm font-medium text-slate-500 dark:text-zinc-400">Establish a new secure pass-key for your account.</p>
            </div>
            ...
            <div class="mt-12 rounded-[2.5rem] bg-white p-10 shadow-2xl ring-1 ring-slate-100 dark:bg-zinc-900 dark:ring-white/5">
                <form method="POST" action="{{ route('password.update') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="email" class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Verified Email</label>
                    ...
                    <div>
                        <label for="password" class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">New Pass-Key</label>
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Confirm Pass-Key</label>
