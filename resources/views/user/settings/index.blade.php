<x-user-layout :title="'Account Settings'">
    <div class="rounded-lg bg-white p-6 shadow-sm ring-1 ring-black/5 dark:bg-zinc-900 dark:ring-white/10">
        ...
        <p class="mt-2 text-sm text-zinc-600 dark:text-zinc-400">Profile, security, and notification preferences
            (wireframe).</p>

        <div class="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
            <div class="rounded-[2rem] bg-zinc-50 p-8 text-sm dark:bg-white/5">
                <div class="text-[10px] font-black uppercase tracking-widest text-zinc-400 dark:text-zinc-500">Identity
                </div>
                ...
                <div class="mt-8">
                    <button
                        class="text-[10px] font-black uppercase tracking-widest text-blue-600 hover:text-blue-700 transition">Modify
                        Profile</button>
                </div>
            </div>
