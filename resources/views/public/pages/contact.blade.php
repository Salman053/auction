            ...
            <div class="grid grid-cols-1 gap-16 lg:grid-cols-2">
                ...
                <div class="lg:max-w-md">
                    ...
                    <h1 class="mt-4 text-4xl font-black tracking-tight text-slate-900 dark:text-white sm:text-6xl">
                        Connect with the Hub.</h1>
                    <p class="mt-8 text-lg font-medium leading-relaxed text-slate-500 dark:text-zinc-400">Our
                        administrative team is available 24/7 for high-value procurement inquiries and technical
                        support.</p>
                    ...
                    <div class="mt-12 space-y-10">
                        ...
                        <div class="flex items-start gap-6">
                            ...
                            <div>
                                <h3 class="text-sm font-black text-slate-900 dark:text-white uppercase tracking-widest">
                                    Tokyo Hub</h3>
                                <p class="mt-2 text-slate-500 dark:text-zinc-400 font-medium">Shiodome City Center
                                    15F,<br>Minato-ku, Tokyo, 105-7115 Japan</p>
                            </div>
                        </div>
                    </div>
                ...
                {{-- Form Side --}}
                <div
                    class="rounded-[3rem] bg-white p-10 shadow-2xl ring-1 ring-slate-100 dark:bg-zinc-900 dark:ring-white/5 lg:p-12">
                    <form method="POST" action="{{ route('contact.store') }}" class="space-y-8">
                        ...
                        <div class="grid grid-cols-1 gap-8 sm:grid-cols-2">
                            <div>
                                <label for="name"
                                    class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Full
                                    Identity</label>
                            ...
                            <div>
                                <label for="email"
                                    class="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Connect
                                    Email</label>
