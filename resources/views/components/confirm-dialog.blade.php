            ...
            <div class="p-8 sm:p-10">
                <div class="flex items-start gap-5">
                    <div id="confirm-dialog-icon"
                        class="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-brand-gold/10 text-brand-navy">
                    </div>

                    <div class="flex-1">
                        <h3 id="confirm-dialog-title"
                            class="text-xl font-black tracking-tight text-slate-900 dark:text-white"></h3>
                        <p id="confirm-dialog-message"
                            class="mt-3 text-sm font-medium leading-relaxed text-slate-500 dark:text-zinc-400"></p>
                    </div>
                </div>
