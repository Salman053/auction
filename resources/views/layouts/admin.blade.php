        ...
        <aside
            ...
            <div class="flex h-[var(--topbar-height)] items-center px-8">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2.5">
                    ...
                    <span class="text-xl font-black tracking-tighter text-zinc-900 dark:text-white">AdminHub</span>
                </a>
            </div>

            <nav class="flex-1 space-y-1 overflow-y-auto px-6 py-8">
                <p class="mb-4 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">System Control</p>
                ...
                <p class="mb-4 mt-8 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Financials</p>
                ...
                <p class="mb-4 mt-8 px-3 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400">Operations</p>
    ...
    <div id="mobileBottomNav"
        ...
        <div class="flex items-center justify-around px-2 py-2">
            ...
            <a href="{{ route('admin.dashboard') }}"
                class="mobile-nav-item flex flex-col items-center justify-center gap-1 rounded-lg px-3 py-2 transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'text-blue-600 dark:text-blue-500' : 'text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-white/10' }}">
            ...
            <a href="{{ route('admin.users.index') }}"
                class="mobile-nav-item flex flex-col items-center justify-center gap-1 rounded-lg px-3 py-2 transition-all duration-200 {{ request()->routeIs('admin.users.*') ? 'text-blue-600 dark:text-blue-500' : 'text-slate-500 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-white/10' }}">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 4.354a4 4 0 110 5.292M15 21H3v-1awww6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                </svg>
            ...
            <a href="{{ route('admin.auctions.index') }}"
                class="mobile-nav-item flex flex-col items-center justify-center gap-1 rounded-lg px-3 py-2 transition-all duration-200 {{ request()->routeIs('admin.auctions.*') ? 'text-blue-600 dark:text-blue-500' : 'text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-white/10' }}">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
            ...
            <a href="{{ route('admin.deposits.index') }}"
                class="mobile-nav-item flex flex-col items-center justify-center gap-1 rounded-lg px-3 py-2 transition-all duration-200 {{ request()->routeIs('admin.deposits.*') || request()->routeIs('admin.withdrawals.*') ? 'text-blue-600 dark:text-blue-500' : 'text-zinc-500 hover:bg-zinc-100 dark:text-zinc-400 dark:hover:bg-white/10' }}">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zM17 16l4-4m0 0l-4-4m4 4H7" />
                </svg>
            ...
            <button id="mobileMoreButton"
                class="flex flex-col items-center justify-center gap-1 rounded-lg px-3 py-2 text-slate-500 transition-all duration-200 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-white/10">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 6h16M4 12h16M4 18h16" />
                </svg>
        ...
        <div class="flex h-full flex-col">
            ...
            <nav class="flex-1 overflow-y-auto px-4 py-6">
                <div class="space-y-1">
                    ...
                    <a href="{{ route('admin.dashboard') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-zinc-700 hover:bg-zinc-100 dark:text-zinc-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.users.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                        </svg>
                    ...
                    <a href="{{ route('admin.auctions.index') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.auctions.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                        </svg>
                    ...
                    <a href="{{ route('admin.deposits.index') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.deposits.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 8c-1.657 0-3 1.343-3 3s1.343 3 3 3 3-1.343 3-3-1.343-3-3-3zM17 16l4-4m0 0l-4-4m4 4H7" />
                        </svg>
                    ...
                    <a href="{{ route('admin.withdrawals.index') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.withdrawals.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M17 16l4-4m0 0l-4-4m4 4H7" />
                        </svg>
                    ...
                    <a href="{{ route('admin.proxies.index') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.proxies.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                        </svg>
                    ...
                    <a href="{{ route('admin.scraping-logs.index') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.scraping-logs.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                    ...
                    <a href="{{ route('admin.support-tickets.index') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.support-tickets.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
                    ...
                    <a href="{{ route('admin.profile.edit') }}"
                        class="drawer-nav-link flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-semibold transition-all {{ request()->routeIs('admin.profile.*') ? 'bg-blue-50 text-blue-600 dark:bg-blue-500/20 dark:text-blue-400' : 'text-slate-700 hover:bg-slate-100 dark:text-slate-300 dark:hover:bg-white/10' }}">
                        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
    ...
    <script>
        (function() {
            ...
            if (financeNav) {
                ...
                if (isFinanceRoute) {
                    financeNav.classList.add('text-blue-600', 'dark:text-blue-500');
                    financeNav.classList.remove('text-zinc-500', 'dark:text-zinc-400');
                }
            }
        })();
    </script>
