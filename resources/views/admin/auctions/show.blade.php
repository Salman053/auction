    ...
    <div class="mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        @if ($auction->status === 'active')
            <form id="sync-auction-form" action="{{ route('admin.auctions.sync', $auction) }}" method="POST">
                @csrf
                <button type="submit" data-confirm data-confirm-title="Sync Auction" data-confirm-text="Sync Now"
                    data-confirm-type="info" data-confirm-on-confirm="#sync-auction-form"
