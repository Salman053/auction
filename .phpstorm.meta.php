...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.S:\projects\yahoo-auction\public\storage' => 'string',
            ...
            'scraper.debug' => 'boolean',
            'scraper.verify_ssl' => 'boolean',
            'scraper.delay' => 'integer',
            'scraper.max_retries' => 'integer',
...
'auth.guards.web.provider','auth.guards.user.driver','auth.guards.user.provider','auth.guards.admin.driver','auth.guards.admin.provider',
...
'filesystems.links.S:\\projects\\yahoo-auction\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'scraper.debug','scraper.verify_ssl','scraper.delay','scraper.max_retries','services.postmark.key',
...
'services.slack.notifications.channel','services.stripe.key','services.stripe.secret','session.driver','session.lifetime',
...
'boost.executable_paths.current_directory','mcp.redirect_domains','mcp.custom_schemes','mcp.authorization_server','ide-helper.filename',
...
'boost.browser-logs','dusk.login','dusk.logout','dusk.user',
'home','auctions.index','auctions.show','about','how-it-works',
'faq','contact','contact.store','stripe.webhook','login',
'login.store','register','register.store','logout','user.dashboard',
'user.auctions.index','user.auctions.show','user.auctions.updates','user.auctions.bids.store','user.auctions.confirm-shipment',
'user.auctions.reject-shipment','user.bids.index','user.bids.cancel','user.watchlist.index','user.watchlist.store',
'user.watchlist.destroy','user.wallet.index','user.wallet.deposits.store','user.wallet.deposits.stripe.success','user.wallet.deposits.stripe.cancel',
'user.support.index','user.support.show','user.support.reply','user.withdrawals.index','user.withdrawals.store',
'user.notifications.index','user.notifications.mark-all-read','user.settings.index','user.profile.edit','user.profile.update',
'user.profile.password.update','admin.login','admin.login.store','admin.logout','admin.dashboard',
'admin.users.index','admin.users.suspend','admin.users.multiplier','admin.deposits.index','admin.deposits.decide',
'admin.withdrawals.index','admin.withdrawals.decide','admin.settings.index','admin.settings.update','admin.audit-logs.index',
'admin.support-tickets.index','admin.support-tickets.show','admin.support-tickets.reply','admin.notifications.index','admin.notifications.mark-all-read',
'admin.reports.index','admin.analytics.index','admin.auctions.index','admin.auctions.show','admin.auctions.approve-shipment',
'admin.auctions.reject-shipment','admin.proxies.index','admin.scraping-logs.index','admin.shipping_rates.index','admin.shipping_rates.create',
'admin.shipping_rates.store','admin.shipping_rates.show','admin.shipping_rates.edit','admin.shipping_rates.update','admin.shipping_rates.destroy',
'admin.profile.edit','admin.profile.update','admin.profile.password.update','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'admin.analytics.index','admin.auctions.index','admin.auctions.show','admin.audit-logs.index','admin.dashboard',
'admin.deposits.index','admin.notifications.index','admin.profile.edit','admin.proxies.index','admin.reports.index',
'admin.scraping-logs.index','admin.settings.index','admin.shipping_rates.create','admin.shipping_rates.edit','admin.shipping_rates.index',
'admin.support-tickets.index','admin.support-tickets.show','admin.users.index','admin.withdrawals.index','auctions.index',
'auth.admin.login','auth.user.login','auth.user.register','components.admin-layout','components.admin.auction.tab-bids',
'components.admin.auction.tab-images','components.admin.auction.tab-raw','components.admin.auction.tab-results','components.admin.auction.tab-watchers','components.auction-filters',
'components.confirm-dialog','components.dashboard.card','components.dashboard.chart-card','components.dashboard.sidebar-item','components.dashboard.stat-card',
'components.guest-layout','components.notification-dropdown','components.page-loader','components.theme-toggle','components.toast',
'components.user-layout','layouts.admin','layouts.guest','layouts.user','public.auctions.show',
'public.home','public.pages.about','public.pages.contact','public.pages.faq','public.pages.how-it-works',
'user.auctions._bid_history','user.auctions.index','user.auctions.show','user.bids.index','user.dashboard',
'user.notifications.index','user.profile.edit','user.settings.index','user.support.index','user.support.show',
'user.wallet.index','user.watchlist.index','user.withdrawals.index','welcome','laravel-exceptions-renderer::components.badge',
...
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_contain','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.encoding','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid',
'S:.projects.yahoo-auction.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','STRIPE_KEY',
